...
namespace TMS.Areas.Identity.Pages.Account.Manage
{
    ...
    public static class ManageNavPages
    {
        ...
        public static string EditInfoNavClass(ViewContext viewContext) => PageNavClass(viewContext, EditInfo);


        public static string ChangeUsernameNavClass(ViewContext viewContext) => PageNavClass(viewContext, ChangeUsername);
